...
Function PrepareReportParameters(ReportSettings)
	...
	//If SettingsComposer.Settings.AdditionalProperties.OptionName = "Sales by discount card"
	//	Then ReportParameters.Insert ("ShowHeader", True);
	//Else
		ReportParameters.Insert("TitleOutput", TitleOutput);
	//EndIf;
	ReportParameters.Insert("Title"                , Title);
	ReportParameters.Insert("ReportId"      , "SalesByDiscountCards");
