...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If TypeOf(Parameters.Filter) = Type("Structure") Then
		...
		AccordanceElementsFilterSettingsComposition = GetCompositionSettingsFilterItemsCorrespondenceAtServer();
		
		For Each FilterItemFromParameters IN Parameters.Filter Do
		
			SetDataCompositionFilterItemAtServer(AccordanceElementsFilterSettingsComposition, 
