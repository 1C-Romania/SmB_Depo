...
Procedure SetLongActionsDebugConstant() Export
	...
	If NOT Constants.IsThisServerInfobaseConstant.Get() AND NOT Constants.LongActionsDebugMode.Get() Then
...
Function UseMultiCompaniesMode() Export 
	
	Return Constants.UseMultiCompanies.Get();
