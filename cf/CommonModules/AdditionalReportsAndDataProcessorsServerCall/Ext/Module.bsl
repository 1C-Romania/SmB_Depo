...
Function PlaceIntoStorage(Refs, FormID) Export
	...
	If Not AdditionalReportsAndDataProcessors.DataProcessorExportToFileIsAvailable(Refs) Then
		Raise NStr("en='Insufficient rights to export files of additional reports and data processors';ru='Недостаточно прав для выгрузки файлов дополнительных отчетов и обработок'");
	EndIf;
