...
Function RepresentationSynchronizationSettingStep1()
	...
	Return NStr("en='Data synchronization, step 1.';ru='Настройка синхронизации, шаг 1.'");
	
EndFunction

Function RepresentationSynchronizationSettingStep2()
	
	Return NStr("en='Data synchronization, step 2.';ru='Настройка синхронизации, шаг 2.'");
	
EndFunction

Function RepresentationExchangeMessageImporting()
	
	Return NStr("en='Import exchange message.';ru='Загрузка сообщения обмена.'");
	
EndFunction

Function RepresentationCorrespondentDataGetting()
	
	Return NStr("en='Receiving correspondent data.';ru='Получение данных корреспондента.'");
	
EndFunction

Function RepresentationCorrespondentNodesCommonDataGetting()
	
	Return NStr("en='Receiving common data of node of a correspondent.';ru='Получение общих данных узлов корреспондента.'");
	
EndFunction

Function RepresentationCorrespondentAccountingParametersGetting()
	
	Return NStr("en='Receiving accounting parameters of the correspondent';ru='Получение параметров учета корреспондента.'");
