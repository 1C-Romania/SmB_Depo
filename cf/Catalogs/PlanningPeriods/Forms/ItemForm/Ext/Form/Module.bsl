...
Procedure BeginDateOnChange(Item)
	...
	If Object.StartDate > Object.EndDate 
		...
		Message.Text = NStr("en='The Start date field value is greater than the End date field value.';ru='Значение поля ""Дата начала"" больше значения поля ""Дата окончания""'");
...
Procedure EndingDateOnChange(Item)
	...
	If Object.StartDate > Object.EndDate 
		...
		Message = New UserMessage;
		Message.Text = NStr("en='The End date field value is less than the Start date field value.';ru='Значение поля ""Дата окончания"" меньше значения поля ""Дата начала""'");
