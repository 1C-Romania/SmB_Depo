...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If CancelGLAccountChange(Ref) Then
		Items.GLAccountsGroup.ToolTip = NStr("en='Records are registered for this cash fund in the infobase. Cannot change the GL account.';ru='В базе есть движения по этой кассе! Изменение счета учета запрещено!'");
