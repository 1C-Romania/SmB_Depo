...
Procedure FillByCounterparty(Command)
	...
	ShowQueryBox(New NotifyDescription("FillByCounterpartyEnd", ThisObject), NStr("en='The document will be fully filled out. Continue?';ru='Документ будет полностью перезаполнен! Продолжить?'"), QuestionDialogMode.YesNo, 0);
EndProcedure
