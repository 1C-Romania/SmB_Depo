...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	SmallBusinessClientServer.SetListFilterItem(List,"OperationKind",PredefinedValue("Enum.OperationKindsCustomerOrder.JobOrder"));
	...
	If Parameters.Property("FunctionsMenuOrderingStage") Then
		...
		If Parameters.FunctionsMenuOrderingStage = "New" Then
			ThisForm.Title = ThisForm.Title + " (new)";
			If UseStatuses Then
...
Procedure CreateCustomerOrder(Command)
	...
	OpenForm("Document.CustomerOrder.ObjectForm", OpenParameters, Items.List, "NewJobOrder");
...
Procedure FilterCounterpartyOnChange(Item)
	...
	// StandardSubsystems.PerformanceEstimation
	PerformanceEstimationClientServer.StartTimeMeasurement("DocumentsListJobOrderFilterCounterparty");
	// End StandardSubsystems.PerformanceEstimation
...
Procedure ListBeforeAddRow(Item, Cancel, Copy, Parent, Group)
	...
	KeyOperation = "JobOrderFormCreating";
...
Procedure ListBeforeRowChange(Item, Cancel)
	...
	KeyOperation = "JobOrderFormOpening";
	PerformanceEstimationClientServer.StartTimeMeasurement(KeyOperation);
