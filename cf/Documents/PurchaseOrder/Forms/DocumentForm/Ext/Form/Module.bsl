...
Procedure SetVisibleAndEnabled()
	...
	If Object.OperationKind = PredefinedValue("Enum.OperationKindsPurchaseOrder.OrderForPurchase") Then
		...
		Items.GroupInventory.Title = "Products and services";
	...
	Else
		...
		Items.GroupInventory.Title = "Products";
...
Procedure LoadFromFileAtServer(ImportedDataAddress)
	...
	For Each TableRow IN ImportedData Do 
		...
		ElsIf ValueIsFilled(NewStringProducts.ProductsAndServices) Then
			
			NewStringProducts.MeasurementUnit = TableRow.ProductsAndServices.MeasurementUnit;
...
&AtClient
Procedure LoadFromFileEnd(ImportedDataAddress) Export
	...
	Try
		...
		For Each TableRow IN DataMatchingTable Do
			...
			If ImportToApplicationIsPossible Then
				...
				PropertyNames = "ProductsAndServices, Quantity, MeasurementUnit, VATRate, ReceiptDate";
				If GetFunctionalOption("UseCharacteristics") Then
