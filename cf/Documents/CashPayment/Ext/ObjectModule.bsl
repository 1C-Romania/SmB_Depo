...
Procedure FillByTaxAccrual(BasisDocument)
	...
	If BasisDocument.OperationKind <> Enums.OperationKindsTaxAccrual.Accrual Then
		Raise NStr("en='Cash fund expense can be entered only if taxes are accrued, not compensated.';ru='Расход из кассы можно ввести только на основании начисления налогов, а не возмещения.'");
	EndIf;
