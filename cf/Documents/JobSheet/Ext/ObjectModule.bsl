...
Procedure Filling(FillingData, StandardProcessing) Export
	...
	ElsIf TypeOf(FillingData) = Type("DocumentRef.ProductionOrder") Then
		...
		If FillingData.StructuralUnit.StructuralUnitType = Enums.StructuralUnitsTypes.Warehouse Then
			...
			Raise NStr("en='Cannot enter job sheet based on the production order by warehouse.';ru='Сдельный наряд не может быть введен на основании заказа на производство по складу!'");
