...
Procedure ListBeforeAddRow(Item, Cancel, Copy, Parent, Group, Parameter)
	...
	KeyOperation = "FormCreatingCustomerInvoiceNote";
	...
	OpenForm("Document.CustomerInvoiceNote.ObjectForm", FormParameters, Item);
...
Procedure ListBeforeRowChange(Item, Cancel)
	...
	KeyOperation = "FormOpeningCustomerInvoiceNote";
	PerformanceEstimationClientServer.StartTimeMeasurement(KeyOperation);
