...
Procedure CalculateTotalAPDEX(TableOfKeyOperations)
	...
	If MinimalPriority < 1 Then
		MessageText = NStr("en='Priorities are filled in incorrectly. Cannot calculate the total APDEX.';ru='Неверно заполнены приоритеты. Расчет итогового APDEX невозможен.'");
