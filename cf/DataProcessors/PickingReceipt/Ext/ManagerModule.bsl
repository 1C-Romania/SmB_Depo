...
Procedure InformationAboutDocumentStructure(ParametersStructure) Export
	...
	For Each DataProcessorAttribute IN Metadata.DataProcessors.PickingReceipt.Attributes Do
...
Function ChoiceFormFullName() Export
	...
	Return "DataProcessor.PickingReceipt.Form.CartPriceBalanceReserveCharacteristic";
