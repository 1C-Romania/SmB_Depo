...
Procedure AddItemsIntoTabularSection(ItemArray)
	...
	For Each ArrayElement IN ItemArray Do
		...
		If Object.CounterpartyPriceKind.FindRows(New Structure("Ref", ArrayElement)).Count() > 0 Then
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.Property("ArrayCounterpartyPriceKind") Then
		
		For Each ItemOfArray IN Parameters.ArrayCounterpartyPriceKind Do
...
Procedure OK(Command)
	...
	NotifyChoice(FillArrayByTabularSectionAtClient("CounterpartyPriceKind"));
