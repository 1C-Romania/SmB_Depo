		...
		If Ref.Posted Then // For non-posted documents export a blank record set
			...
			If TypeOf(Ref) = Type("DocumentRef.CashReceipt") Then
				...
				If Ref.OperationKind = Enums.OperationKindsCashReceipt.FromCustomer Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Cash receipt from customer ""%1""';ru='Поступление наличных денежных средств от покупателя ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsCashReceipt.FromVendor Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Cash receipt from supplier ""%1""';ru='Поступление наличных денежных средств от поставщика ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsCashReceipt.FromAdvanceHolder Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Cash receipt from advance holder ""%1""';ru='Поступление наличных денежных средств от подотчетника ""%1""'"), TrimAll(Ref.AdvanceHolder));
				...
				ElsIf Ref.OperationKind = Enums.OperationKindsCashReceipt.CurrencyPurchase Then
					OperationKindRow = NStr("en='Receipt of cash funds by currency operations';ru='Поступление наличных денежных средств по валютным операциям'");
				ElsIf Ref.OperationKind = Enums.OperationKindsCashReceipt.Other Then
					OperationKindRow = NStr("en='Receipt of cash funds by other operations';ru='Поступление наличных денежных средств по прочим операциям'");
				EndIf;
			...
			ElsIf TypeOf(Ref) = Type("DocumentRef.PaymentReceipt") Then
				...
				If Ref.OperationKind = Enums.OperationKindsPaymentReceipt.FromCustomer Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Non-cash receipt from customer ""%1""';ru='Поступление безналичных денежных средств от покупателя ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentReceipt.FromVendor Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Non-cash receipt from supplier ""%1""';ru='Поступление безналичных денежных средств от поставщика ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentReceipt.FromAdvanceHolder Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Non-cash receipt from advance holder ""%1""';ru='Поступление безналичных денежных средств от подотчетника ""%1""'"), TrimAll(Ref.AdvanceHolder));
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentReceipt.CurrencyPurchase Then
					OperationKindRow = NStr("en='Receipt of the non cash assets by the currency operations';ru='Поступление безналичных денежных средств по валютным операциям'");
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentReceipt.Other Then
					OperationKindRow = NStr("en='Non cash assets receipt by other operations';ru='Поступление безналичных денежных средств по прочим операциям'");
				EndIf;
			...
			ElsIf TypeOf(Ref) = Type("DocumentRef.CashPayment") Then
				...
				If Ref.OperationKind = Enums.OperationKindsCashPayment.Vendor Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Cash expense for payment to supplier ""%1""';ru='Расход наличных денежных средств на оплату поставщику ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsCashPayment.ToCustomer Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Cash expense for payment to customer ""%1""';ru='Расход наличных денежных средств на оплату покупателю ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsCashPayment.ToAdvanceHolder Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Cash dispense to advance holder ""%1""';ru='Выдача наличных денежных средств подотчетнику ""%1""'"), TrimAll(Ref.AdvanceHolder));
				ElsIf Ref.OperationKind = Enums.OperationKindsCashPayment.Salary
					...
					OperationKindRow = NStr("en='Cash assets expense for the payroll payment';ru='Расход наличных денежных средств на выплату заработной платы'");
				ElsIf Ref.OperationKind = Enums.OperationKindsCashPayment.Taxes Then
					OperationKindRow = NStr("en='Cash funds expense for the taxes payment';ru='Расход наличных денежных средств на уплату налогов'");
				ElsIf Ref.OperationKind = Enums.OperationKindsCashPayment.TransferToCashCR Then
					OperationKindRow = NStr("en='Transfer of cash funds to the CR';ru='Перемещение наличных денежных средств в кассу ККМ'");
				ElsIf Ref.OperationKind = Enums.OperationKindsCashPayment.Other Then
					OperationKindRow = NStr("en='Cash funds expense by other operations';ru='Расход наличных денежных средств по прочим операциям'");
				EndIf;
				
			ElsIf TypeOf(Ref) = Type("DocumentRef.PaymentExpense") Then
				
				If Ref.OperationKind = Enums.OperationKindsPaymentExpense.Vendor Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Non-cash expense for payment to supplier ""%1""';ru='Расход безналичных денежных средств на оплату поставщику ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentExpense.ToCustomer Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Non-cash expense for payment to customer ""%1""';ru='Расход безналичных денежных средств на оплату покупателю ""%1""'"), TrimAll(Ref.Counterparty));
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentExpense.ToAdvanceHolder Then
					OperationKindRow = StringFunctionsClientServer.SubstituteParametersInString(NStr("en='Non-cash payment to advance holder ""%1""';ru='Выдача безналичных денежных средств подотчетнику ""%1""'"), TrimAll(Ref.AdvanceHolder));
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentExpense.Salary Then
					OperationKindRow = NStr("en='Expense of the noncash assets for the payroll payment';ru='Расход безналичных денежных средств на выплату заработной платы'");
				ElsIf Ref.OperationKind = Enums.OperationKindsPaymentExpense.Taxes Then
					OperationKindRow = NStr("en='Non-cash expense for taxes';ru='Расход безналичных денежных средств на уплату налогов'");
