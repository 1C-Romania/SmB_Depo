...
Function PrintTemplate() Export
	...
	Template = DataProcessors.AccountManagement.GetTemplate("Template");
	...
	For Each Result In Results Do
		...
		While Selection.Next() Do
			...
			RegTest =  New Structure("MetadataName, ResourcesCount",InfoRegister.Metadata.Name, InfoRegister.Metadata.Resources.Count());

			AreaRowDimension.Parameters.Decipher = New Structure("Register, Period, Object, ItsNew, Cell, OpenObjectForm", RegTest, Period, Object, ItsNew, Cell, True);
			...
			Cell = "Period";
			AreaRowPeriod.Parameters.Decipher = New Structure("Register, Period, Object, ItsNew, Cell", RegTest, Period, Object, ItsNew, Cell);
			AreaRowPeriod.Parameters.Period = Selection.Period;
			SpreadsheetDocument.Join(AreaRowPeriod);
			
			For Each Resource In InfoRegister.Resources Do
				Cell = Resource.Name;
				AreaRowResource.Parameters.Decipher = New Structure("Register, Period, Object, ItsNew, Cell", RegTest, Period, Object, ItsNew, Cell);
				If ItsNew Then
	...
	RetStruct  =  New Structure();
	RetStruct.Insert("SpreadsheetDoc",SpreadsheetDocument);
	RetStruct.Insert("MapObjects",MapObjects); 
