...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	MessageText = NStr("en='Warning! Full exchange may take a long time. Continue?';ru='Внимание! Выполнение полного обмена может занять длительное время. Продолжить?'");
