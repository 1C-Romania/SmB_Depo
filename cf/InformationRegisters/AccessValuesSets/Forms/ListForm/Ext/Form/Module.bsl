...
Procedure SetConditionalAppearance()
	...
	Item.Appearance.SetParameterValue("Text", NStr("en='Check the Read right';ru='Проверка права Чтение'"));
	Item.Appearance.SetParameterValue("Text", NStr("en='Check the Edit right';ru='Проверка права Изменение'"));
