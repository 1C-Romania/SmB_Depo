...
Procedure MetadataObjectTreeFill()
	...
	CollectionsOfMetadataObjects_NewRow("Subsystems",                   NStr("en='Subsystems';ru='Подсистемы'"),                     35, 36, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonModules",                  NStr("en='Common modules';ru='Общие модули'"),                   37, 38, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("SessionParameters",              NStr("en='Session parameters';ru='Параметры сеанса'"),               39, 40, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Roles",                         NStr("en='Roles';ru='Роли'"),                           41, 42, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ExchangePlans",                  NStr("en='Exchange plans';ru='Планы обмена'"),                   43, 44, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("FilterCriteria",               NStr("en='Filter criteria';ru='Критерии отбора'"),                45, 46, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("EventSubscriptions",            NStr("en='Subscription to events';ru='Подписки на события'"),            47, 48, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ScheduledJobs",          NStr("en='Scheduled jobs';ru='Регламентные задания'"),           49, 50, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("FunctionalOptions",          NStr("en='Functional options';ru='Функциональные опции'"),           51, 52, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("FunctionalOptionsParameters", NStr("en='Functional option parameters';ru='Параметры функциональных  опций'"), 53, 54, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("SettingsStorages",            NStr("en='Setting storage';ru='Хранилища настроек'"),             55, 56, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonForms",                   NStr("en='Common forms';ru='Общие формы'"),                    57, 58, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonCommands",                 NStr("en='Common commands';ru='Общие команды'"),                  59, 60, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommandGroups",                 NStr("en='Command groups';ru='Группы команд'"),                  61, 62, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Interfaces",                   NStr("en='Interfaces';ru='Интерфейсы'"),                     63, 64, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonTemplates",                  NStr("en='Common templates';ru='Общие макеты'"),                   65, 66, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonPictures",                NStr("en='Common pictures';ru='Общие картинки'"),                 67, 68, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("XDTOPackages",                   NStr("en='XDTO-packages';ru='XDTO-packages'"),                    69, 70, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("WebServices",                   NStr("en='Web-Services';ru='Web-Services'"),                    71, 72, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("WSReferences",                     NStr("en='WS references';ru='WS-references'"),                      73, 74, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Styles",                        NStr("en='Styles';ru='Стили'"),                          75, 76, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Languages",                        NStr("en='Languages';ru='Языки'"),                          77, 78, True, CollectionsOfMetadataObjects);
	
	CollectionsOfMetadataObjects_NewRow("Constants",                    NStr("en='Constants';ru='Константы'"),                      PictureLib.Constant,              PictureLib.Constant,                    False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Catalogs",                  NStr("en='Catalogs';ru='Справочники'"),                    PictureLib.Catalog,             PictureLib.Catalog,                   False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Documents",                    NStr("en='Documents';ru='Документы'"),                      PictureLib.Document,               PictureLib.DocumentObject,               False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("DocumentJournals",            NStr("en='Document logs';ru='Журналы документов'"),             PictureLib.DocumentJournal,       PictureLib.DocumentJournal,             False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Enums",                 NStr("en='Transfers';ru='Перечисления'"),                   PictureLib.Enum,           PictureLib.Enum,                 False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Reports",                       NStr("en='Reports';ru='Отчеты'"),                         PictureLib.Report,                  PictureLib.Report,                        False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("DataProcessors",                    NStr("en='Data processors';ru='Обработки'"),                      PictureLib.DataProcessor,              PictureLib.DataProcessor,                    False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfCharacteristicTypes",      NStr("en='Charts of characteristic types';ru='Планы видов характеристик'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfAccounts",                  NStr("en='Charts of accounts';ru='Планы счетов'"),                   PictureLib.ChartOfAccounts,             PictureLib.ChartOfAccountsObject,             False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfCalculationTypes",            NStr("en='Charts of characteristic types';ru='Планы видов характеристик'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("InformationRegisters",             NStr("en='Information registers';ru='Регистры сведений'"),              PictureLib.InformationRegister,        PictureLib.InformationRegister,              False, CollectionsOfMetadataObjects);
