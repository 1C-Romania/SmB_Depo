...
Procedure WriteAndCloseExecute()
	...
	Else
		MessageText = NStr("en='Barcode scanner suffix is not specified. Suffix must be specified to identify the barcode.';ru='Не указан суффикс сканера штрихкода. Для идентификации штрихкода суффикс должен быть указан.'");
