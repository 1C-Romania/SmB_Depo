...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If ValueIsFilled(Currency) Then
		...
		NewHeaderRow 						= NStr("en='Goods are picked to the amount of (%InCurrency%)';ru='Товаров подобрано на сумму (%ВВалюте%)'");
...
Procedure CompanyOnChange(Item)
	...
	Else
		...
		Message.Text 		= NStr("en='Fill in company to update form data';ru='Для обновление данных формы заполните организацию'");
