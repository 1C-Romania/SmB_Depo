...
Procedure OnCreateInteractionContext(Context) Export
	...
	Context.Insert("MessageActionsUnavailable",
		NStr("en = 'Displaying of the online support monitor is not available for this configuration.'"));
	...
	Else
		...
		If SettingShowOnUpdate = True
			...
			HandlerContext.Insert("StopCauseDescription",
				NStr("en = 'There is no new information on the server of users online support.'"));
