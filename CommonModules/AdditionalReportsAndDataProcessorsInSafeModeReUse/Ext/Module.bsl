...
Function Dictionary() Export
	...
	Presentation = NStr("en = 'Receiving the data from the Internet'");
	...
	AddParameter(Parameters, "Protocol", NStr("en = 'via protocol %1'"), NStr("en = 'via any protocol'"));
	AddParameter(Parameters, "Port", NStr("en = 'using port %1'"), NStr("en = 'using any port'"));
	...
	Presentation = NStr("en = 'Data transfer to the Internet'");
	Definition = NStr("en = 'Additional report or processing will be allowed to send the data to the Internet network'");
	...
	Presentation = NStr("en = 'References to the web services in the Internet'");
	Definition = NStr("en = 'Additional report or data processor will be permitted to address the web-services located in the Internet (in this case, additional report or data processor can receive and transfer information from the Internet).'");
	...
	Parameters = ParameterTable();
	AddParameter(Parameters, "WsdlDestination", NStr("en = 'by address %1'"), NStr("en = 'by any address'"));
	...
	Presentation = NStr("en = 'Creating COM-object'");
	Definition = NStr("en = 'An additional report or processing will be allowed to use the mechanisms of external software using the COM-connection'");
	...
	Parameters = ParameterTable();
	AddParameter(Parameters, "ProgId", NStr("en = 'with application ID %1'"), NStr("en = 'with any application ID'"));
	...
	Presentation = NStr("en = 'External component object creation'");
	Definition = NStr("en = 'The additional report or processing will be allowed to use the mechanisms of the external software using the creation of the external component object that is provided in the configuration template'");
	Effects = NStr("en = 'Warning! Use of thirdparty software funds can
                        |be used by an additional report or data processor for
                        |actions that are not alleged by infobase administrator, and also for
                        |unauthorized circumvention of the restrictions imposed by the additional processing in safe mode.
	...
	Presentation = NStr("en = 'Receiving of files from external object'");
	Definition = NStr("en = 'The additional report or processing will be allowed to receive the files out of the external software (e.g. using COM-connection or the external component)'");
	...
	Presentation = NStr("en = 'Files transfer to an external object'");
	Definition = NStr("en = 'The additional report or processing will be allowed to transfer the files to the external software (e.g. using COM-connection or the external component)'");
	...
	Definition = NStr("en = 'Additional report or processing will be permitted to modify the documents posting status'");
	
	Parameters = ParameterTable();
	AddParameter(Parameters, "DocumentType", NStr("en = 'documents with type %1'"), NStr("en = 'any documents'"));
	AddParameter(Parameters, "Action", NStr("en = 'Permitted action: %1'"), NStr("en = 'any posting status modification'"));
