...
Function ConnectDevice(DriverObject, Parameters, ConnectionParameters, Output_Parameters) Export
	...
	Parameters.Property("DevicePassword"          , DevicePassword);
	Parameters.Property("TaxPrintInCheck"       , TaxPrintInCheck);
	...
	If Port                       = Undefined
	 ...
	 Or DevicePassword           = Undefined
	 Or TaxPrintInCheck        = Undefined
	...
	If Result Then
		If Parameters.Model = Undefined Then
			Output_Parameters.Add(999);
		...
		ValueArray.Add(Parameters.TaxPrintInCheck);
...
Function ReceiptPrint(DriverObject, Parameters, ConnectionParameters, InputParameters, Output_Parameters)
	...
	Return EquipmentManagerClientOverridable.ReceiptPrint(PeripheralsAtolFiscalRegistersClient,
...
// Prints slip receipt.
//
Function PrintText(DriverObject, Parameters, ConnectionParameters, TextString, Output_Parameters)
...
Function CloseReceipt(DriverObject, Parameters, ConnectionParameters, PaymentsTable, Output_Parameters) Export
	...
	Result = DriverObject.CloseReceipt(ConnectionParameters.DeviceID,
	                                      SumOfCashPayment, AmountOfNonCashPayment);
	If Not Result Then
		Output_Parameters.Clear();
		Output_Parameters.Add(999);
		Output_Parameters.Add("");
