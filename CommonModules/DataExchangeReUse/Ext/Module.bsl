...
Function ErrorMessages() Export
	...
	ErrorMessages.Insert(8,  NStr("en = 'File name to export data is not correct'"));
	...
	ErrorMessages.Insert(177, NStr("en = 'The exchange plan name from the exchange message does not correspond to the expected one.'"));
	ErrorMessages.Insert(178, NStr("en = 'Recipient of the exchange message does not correspond to the expected one.'"));
...
Function OfflineWorkExchangePlan() Export
	...
	If Result.Count() = 0 Then
		...
		Raise NStr("en = 'Offline work in the system is not provided.'");
		
	ElsIf Result.Count() > 1 Then
		
		Raise NStr("en = 'More than one exchange plan has been created for the offline work.'");
	...
	Else
		...
		If Not Directory.Exist() Then
			...
			MessagePattern = NStr("en = 'Temporary file directory does not exist.
					...
					|parameter value %1 is specified in the application settings.'");
