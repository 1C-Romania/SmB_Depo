...
Procedure DetermineSectionsWithReportVariants(Sections) Export
	...
	Sections.Add(Metadata.Subsystems.MarketingAndSales, NStr("en = 'Marketing and sales'"));
	Sections.Add(Metadata.Subsystems.InventoryAndPurchasing, NStr("en = 'Inventory and purchasing'"));
	Sections.Add(Metadata.Subsystems.Services, NStr("en = 'Service'"));
	Sections.Add(Metadata.Subsystems.KittingAndProduction, NStr("en = 'Production'"));
	Sections.Add(Metadata.Subsystems.CashAssets, NStr("en = 'Cash assets'"));
	Sections.Add(Metadata.Subsystems.PayrollAndHumanResources, NStr("en = 'Payroll and Human Resources'"));
	Sections.Add(Metadata.Subsystems.Enterprise, NStr("en = 'Enterprise'"));
...
Procedure ConfigureReportsVariants(Settings) Export
	...
	Variant.Definition = NStr("en = 'The report presents analysis of the customer orders processing'");
	...
	Variant.Definition = NStr("en = 'The report allows to analyse payment of orders of buyers'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PurchaseOrdersPaymentAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report presents analysis of the payment by orders to suppliers'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.DemandAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report presents analysis of supplying raw materials and materials requirements to perform work, provide services, necessary for production'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InvoiceForPaymentAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report analyzes bill payments by the customers'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SupplierInvoiceForPaymentAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report presents analysis of the payment of suppliers invoices'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.BalanceSheet, "Default");
	Variant.Definition = NStr("en = 'The report presents balance sheet statement for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashFlowStatementBudget, "Default");
	Variant.Definition = NStr("en = 'The report presents Cash Flow Budget by specified scenario'");
	...
	Variant.Definition = NStr("en = 'The report presents profit and loss budget by the specified scenario'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.ProfitsAndLossesBudget, "Planfact analysis");
	Variant.Definition = NStr("en = 'The report presents plan/actual analysis of the profit and loss budget by the specified scenario'");
	...
	Variant.Definition = NStr("en = 'The report is used to evaluate the cost of products in stock according to the price kind specified'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.MutualSettlements, "Statement");
	Variant.Definition = NStr("en = 'The report presents the dynamics of the settlements with customers and suppliers in total for the specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.MutualSettlements, "Balance");
	Variant.Definition = NStr("en = 'Report reflects the state mutual settlements with the customers and suppliers summarily for the selected period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.MutualSettlements, "Statement in currency");
	Variant.Definition = NStr("en = 'The report presents the dymanics of the settlements with customers and suppliers in total for the specified period in the settlements currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.MutualSettlements, "Balance in currency");
	Variant.Definition = NStr("en = 'The report presents the state of the settlements with customers and suppliers in total for the specified date in the settlements currency'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.MutualSettlements, "Statement in currency (briefly)");
	Variant.Definition = NStr("en = 'The report presents the dynamics of the settlements with customers and suppliers in total for the specified period in the settlements currency (briefly)'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.MutualSettlementsBriefly, "Statement in currency (briefly)");
	Variant.Definition = NStr("en = 'The report presents the settlements with customers and suppliers in total for the specified accounting period (briefly without contract details)'");
	Variant.Enabled = False;
	Variant.Placement.Clear();
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.FixedAssets, "Statement");
	Variant.Definition = NStr("en = 'The report presents the summary data on the assets depreciation'");
	...
	Variant.Definition = NStr("en = 'The report presents the work performed, services rendered and products release'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.FixedAssetsOutput, "Default");
	Variant.Definition = NStr("en = 'The report shows fixed assets output for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InventoryTransferSchedule, "Default");
	Variant.Definition = NStr("en = 'The report shows planned receipts and shipment of the goods items by orders quantification for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AvailabilityAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report shows available balance of goods at warehouses.'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashFlow, "Default");
	Variant.Definition = NStr("en = 'Statement of Cash Flow of the enterprise for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "Statement");
	Variant.Definition = NStr("en = 'The report generates statement of cash flow by petty cashes and bank accounts for the selected period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "Balance");
	Variant.Definition = NStr("en = 'The report shows cash balances of accounts and petty cashes on the specified date'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "Movements analysis");
	Variant.Definition = NStr("en = 'The report shows cash flow, detailed by items for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "StatementInCurrency");
	Variant.Definition = NStr("en = 'The report generates statement of cash flow by petty cashes and bank accounts for the selected period in cash currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'The report shows cash balances of accounts and petty cashes on the specified date in cash currency'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "Analysis of movements in currency");
	Variant.Definition = NStr("en = 'The report shows cash flow, detailed by items for the specified period in cash currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "CashReceiptsDynamics");
	Variant.Definition = NStr("en = 'The report presents the cash receipt dynamics detailed by items over the specified period of time in accounting currency'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssets, "CashExpenseDynamics");
	Variant.Definition = NStr("en = 'The report presents the cash expense dynamics detailed by items over the specified period of time in accounting currency'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashInCashRegisters, "Statement");
	Variant.Definition = NStr("en = 'The report shows cash flow in cash registers for the selected period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashInCashRegisters, "Balance");
	Variant.Definition = NStr("en = 'The report shows cash balances of the cash registers on the specified date'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashInCashRegisters, "StatementInCurrency");
	Variant.Definition = NStr("en = 'The report shows cash flow in cash registers for the selected period in the cash currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashInCashRegisters, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'Report displays the cash assets balances in the cash registers for the specified date in the cash assets currency'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssetsForecast, "Default");
	Variant.Definition = NStr("en = 'The report shows planned cash flow by specified scenario'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssetsForecast, "InCurrency");
	Variant.Definition = NStr("en = 'The report shows planned cash flow by specified scenario in cash currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssetsForecast, "Planfact analysis");
	Variant.Definition = NStr("en = 'The report shows cash flow plan/actual analysis'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CashAssetsForecast, "Planfact analysis (cur.)");
	Variant.Definition = NStr("en = 'The report shows cash flow plan/actual analysis in cash currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PlannedCashBalance, "Default");
	Variant.Definition = NStr("en = 'Report shows information on planned cash balances in selected currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.IncomeAndExpenses, "Statement");
	Variant.Definition = NStr("en = 'The report presents income and expences forecast (by the shipment)'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.IncomeAndExpenses, "IncomeAndExpensesByOrders");
	Variant.Definition = NStr("en = 'The report contains data on income and expenses by customer orders (shipment)'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.IncomeAndExpenses, "IncomeAndExpensesDynamics");
	Variant.Definition = NStr("en = 'The report presents the change dynamics of income, expenses and profit (by shipment) for the specified period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.IncomeAndExpensesByCashMethod, "Default");
	Variant.Definition = NStr("en = 'The report presents income and expenses data (by the payments)'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.IncomeAndExpensesByCashMethod, "IncomeAndExpensesDynamics");
	Variant.Definition = NStr("en = 'The report presents the change dynamics of income, expenses and profit (by payment) for the specified period of time'");
	Variant.VisibleByDefault = False;
	...
	Variant.Definition = NStr("en = 'The report presents plan/actual analysis of income and expences (by the shipment)'");
	...
	Variant.Definition = NStr("en = 'The report persents information for the customer about performed work orders'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.ProductionOrders, "Statement");
	Variant.Definition = NStr("en = 'The report shows orders processing dynamic for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.ProductionOrders, "Balance");
	Variant.Definition = NStr("en = 'The report presents analysis of state orders on the specified date'");
	Variant.VisibleByDefault = False;
	...
	Variant.Definition = NStr("en = 'The report shows state orders on the specified date'");
	Variant.VisibleByDefault = False;
	...
	Variant.Definition = NStr("en = 'The report presents the analysis of products and services purchased by the company within the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Inventory, "Statement");
	Variant.Definition = NStr("en = 'The report presents information about receipt, shipment and current quantity of inventory in available balance and in reserve under orders of buyers'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Inventory, "Balance");
	Variant.Definition = NStr("en = 'Report reflects the inventory status for the specified date'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SurplusesAndShortages, "Default");
	Variant.Definition = NStr("en = 'The report presents the data on the surpluses and shortages according to the results of reconciliation'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InventoryByCCD, "Statement");
	Variant.Definition = NStr("en = 'The report presents information about receipt, shipment and current quantity of any of the imported goods, whith CCD number'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InventoryByCCD, "Balance");
	Variant.Definition = NStr("en = 'The report presents information about current quantity of any of the imported goods, whith CCD number'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InventoryTransferred, "Statement");
	Variant.Definition = NStr("en = 'The report presents information about inventory changes, received on commission, for processing, and on the safe custody by specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InventoryTransferred, "Balance");
	Variant.Definition = NStr("en = 'The report presents information about inventory balance, received on commission, for processing, and on the safe custody by specified period'");
	Variant.VisibleByDefault = False;
	...
	Variant.Definition = NStr("en = 'Report allows us to receive information about events grouped by the statuses (delayed, as of today, scheduled).'");
	...
	Variant.Definition = NStr("en = 'The report shows employees earnings and deductions with detailed earning/deduction type'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccrualsAndDeductions, "InCurrency");
	Variant.Definition = NStr("en = 'The report shows employees earnings and deductions in currency with detailed earning/deduction type'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.UFP, "Statement");
	Variant.Definition = NStr("en = 'The report presents the data on changes in direct and indirect costs of the company. Data is presented in terms of divisions with the detalization by the customer orders'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.UFP, "Balance");
	Variant.Definition = NStr("en = 'The report presents data on the state of direct and indirect costs of the company. Data is presented in terms of divisions with the detalization by the customer orders'");
	Variant.VisibleByDefault = False;
	...
	Report.Definition = NStr("en = 'The report presents information about standards and technologies of works and finished products'");
	Report.SearchSettings.FieldNames =
		NStr("en = 'Products
		|and services
		|Technological operation Accounting price'");
	Report.SearchSettings.ParametersAndFiltersNames =
		NStr("en = 'Date
		|of calculation
		|Prices
		|kind
		|Products and services Characteristic Specification'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.InventoryTurnover, "Default");
	Variant.Definition = NStr("en = 'The report presents analysis of turnover and Average inventory life'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.TurnoverBalanceSheet, "TBS");
	Variant.Definition = NStr("en = 'The report contains information about opening and closing balance by GL accounts, and turnovers by GL accounts for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.WorkedTime, "ByDays");
	Variant.Definition = NStr("en = 'The report shows work time expenditures by days in specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.WorkedTime, "TotalForPeriod");
	Variant.Definition = NStr("en = 'The report presents total work time detailed to the type of work time within the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SalesPlanActualAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report presents correlation of planned and actual sales analysis'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.ProductionPlanActualAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report presents plan/actual analysis of performed work, performed services, output of products'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SalesTargets, "Default");
	Variant.Definition = NStr("en = 'The report shows information about planned items of goods sale, grouped by divisions'");
	...
	Variant.Definition = NStr("en = 'The report presents information about gains and losses for the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.BalanceEstimation, "Default");
	Variant.Definition = NStr("en = 'The report generates budget by balance sheet by the specified scenario'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.BalanceEstimation, "Planfact analysis");
	Variant.Definition = NStr("en = 'The report shows plan/actual of budget execution by balance sheet'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "Default");
	Variant.Definition = NStr("en = 'The report presents products and services items sold within the specified period by quantity and amount'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "GrossProfit");
	Variant.Definition = NStr("en = 'The report shows gross profit by specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "GrossProfitByProductsAndServicesCategories");
	Variant.Definition = NStr("en = 'The report presents the gross profit by products and sevices categories over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "GrossProfitByCustomers");
	Variant.Definition = NStr("en = 'The report presents gross profit by customers over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "GrossProfitByManagers");
	Variant.Definition = NStr("en = 'The report presents gross profit by managers over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "SalesDynamics");
	Variant.Definition = NStr("en = 'The report displays the sales dynamics by periods over a certain period of time'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "SalesDynamicsByProductsAndServices");
	Variant.Definition = NStr("en = 'The report presents the sales dynamics by products and services over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "SalesDynamicsByProductsAndServicesCategories");
	Variant.Definition = NStr("en = 'The report presents the sales dynamics by products and services categories over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "SalesDynamicsByCustomers");
	Variant.Definition = NStr("en = 'The report presents the sales dynamics by customers over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Sales, "SalesDynamicsByManagers");
	Variant.Definition = NStr("en = 'The report presents the sales dynamics by managers over a certain period of time'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.OrdersPlacement, "Statement");
	Variant.Definition = NStr("en = 'The report presents the changes of customer orders that are fulfilled due to the receipts under other orders - purchase and kitting orders, production'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.OrdersPlacement, "Balance");
	Variant.Definition = NStr("en = 'The report presents the data on customer orders that are fulfilled due to the receipts under other orders - purchase and kitting orders, production'");
	Variant.VisibleByDefault = False;
	
	Report = ReportsVariants.ReportDescription(Settings, Metadata.Reports.PaySheet);
	ReportsVariants.SetOutputModeInReportPanels(Settings, Report, True);	
	Report.Definition = NStr("en = 'Payroll sheet of an arbitrary form. Is intended for internal enterprise reporting'");
	Report.SearchSettings.FieldNames =
		NStr("en = 'Employee
		|code
		|Employee
	...
	ReportsVariants.SetOutputModeInReportPanels(Settings, Report, True);	
	Report.Definition = NStr("en = 'The report generates statemets of earnings, selected and grouped by companies and divisions'");
	Report.SearchSettings.FieldNames =
		NStr("en = 'Employee
		|code
		|Employee
	...
	Variant.Definition = NStr("en = 'The report presents information about settlements in respect of taxes and levies, by type of tax'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.TaxesSettlements, "Balance");
	Variant.Definition = NStr("en = 'The report presents information about state of settlements in respect of taxes and levies, by type of tax'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PayrollPayments, "Statement");
	Variant.Definition = NStr("en = 'The report shows changes of arrearage of wages in specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PayrollPayments, "Balance");
	Variant.Definition = NStr("en = 'The report shows state of arrearage of wages in specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PayrollPayments, "StatementInCurrency");
	Variant.Definition = NStr("en = 'The report shows changes of salary arrearage in the settlements currency over the specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PayrollPayments, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'The report shows state of arrearage of wages in currency of account in specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AdvanceHolderPayments, "Statement");
	Variant.Definition = NStr("en = 'The report shows debts changes on settlements with advance holders in specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AdvanceHolderPayments, "Balance");
	Variant.Definition = NStr("en = 'The report shows state of debts on settlements with advance holders in specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AdvanceHolderPayments, "StatementInCurrency");
	Variant.Definition = NStr("en = 'The report shows debts changes on settlements with advance holders in currency of accounts in specified period'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AdvanceHolderPayments, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'The report shows state of debts on settlements with advance holders in currency of accounts in specified period'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivable, "Statement");
	Variant.Definition = NStr("en = 'The report shows information about accounts with customers, including orders and contracts - in a frames of wich deals were accomplished'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivable, "Balance");
	Variant.Definition = NStr("en = 'The report shows information about balances of accounts with customers, including orders and contracts - in a frames of wich deals were accomplished'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivable, "StatementInCurrency");
	Variant.Definition = NStr("en = 'The report shows information about accounts with customers in currency of accounts, including orders and contracts - in a frames of wich deals were accomplished'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivable, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'The report shows information about balances of accounts with customers in currency of accounts, including orders and contracts - in a frames of wich deals were accomplished'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivableDynamics, "DebtDynamics");
	Variant.Definition = NStr("en = 'The report presents the dynamics of changes in total and overdue debts of customers for the specified period of time'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsPayable, "Statement");
	Variant.Definition = NStr("en = 'The report presents data on the settlements with suppliers including orders and contracts under which there were deals between the company and counterparties'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsPayable, "Balance");
	Variant.Definition = NStr("en = 'The report presents the data on the balances of settlements with suppliers including orders and contracts under which there were deals between the company and conterparties'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsPayable, "StatementInCurrency");
	Variant.Definition = NStr("en = 'The report presents the data on the settlements with suppliers in the settlement currency including orders and contracts under which there were deals between the company and counterparties'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsPayable, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'The report presents the data on the balances of settlements with suppliers in the settlement currency including orders and contracts under which there were deals between the company and counterparties'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.DynamicsOfDebtToSuppliers, "DebtDynamics");
	Variant.Definition = NStr("en = 'The report presents the dynamics of changes in total and overdue debts to suppliers for the specified period of time'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivableAgingRegister, "Default");
	Variant.Definition = NStr("en = 'The report presents the amount of receivables with due dates indication'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsReceivableAgingRegister, "InCurrency");
	Variant.Definition = NStr("en = 'The report presents the amount of receivables from counterparties in the settlement currency with due dates indication'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsPayableAgingRegister, "Default");
	Variant.Definition = NStr("en = 'The report shows amount of debts to counterparties (trade liabilities) with due dates indication'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AccountsPayableAgingRegister, "InCurrency");
	Variant.Definition = NStr("en = 'The report presents the amount of debts to counterparties the settlement currency with due dates indication'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.CustomersOrdersConsolidatedAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report allows to analyze the execution of customer orders by amount and quantity'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.PurchaseOrdersConsolidatedAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report allows to analyze the execution of purchase orders by amount and quantity'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.JobSheets, "Default");
	Variant.Definition = NStr("en = 'The report presents plan/actual analysis of technological operations, performed by employees in job sheet context'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Cost, "Full");
	Variant.Definition = NStr("en = 'The report presents the data on the net cost of the products released, work and services rendered, with the details of expenses incurred'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Cost, "Default");
	Variant.Definition = NStr("en = 'The report contains production cost, works, and services data'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.OutputNetCostPlanActualAnalysis, "Default");
	Variant.Definition = NStr("en = 'The report is used for the plan/fact analysis of the products release costs'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Warehouse, "Statement");
	Variant.Definition = NStr("en = 'The report presents full information about receipt, shipment and current quantity of goods in specified location'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.Warehouse, "Balance");
	Variant.Definition = NStr("en = 'The report shows state of warehouse, information for storekeeper'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.EmployeesLists, "EmployeesList");
	Variant.Definition = NStr("en = 'Report shows human resources information'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.EmployeesLists, "AccrualsPlan");
	Variant.Definition = NStr("en = 'Report shows payroll accounting information'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.EmployeesLists, "PassportData");
	Variant.Definition = NStr("en = 'Report shows Passport Information of individuals'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.EmployeesLists, "ContactInformation");
	Variant.Definition = NStr("en = 'Report displays the individuals contact information'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.RetailAmountAccounting, "Statement");
	Variant.Definition = NStr("en = 'Report presents sales analysis by retail location using accrual accounting'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.RetailAmountAccounting, "Balance");
	Variant.Definition = NStr("en = 'Report presents state of sales analysis by retail location using accrual accounting'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.RetailAmountAccounting, "StatementInCurrency");
	Variant.Definition = NStr("en = 'Report presents sales analysis by retail location using accrual accounting in foreign currency'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.RetailAmountAccounting, "BalanceInCurrency");
	Variant.Definition = NStr("en = 'Report presents  analysis of state of retail sales debt using accrual accounting in foreign currency'");
	Variant.VisibleByDefault = False;
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SalesReportTORG29, "Default");
	Variant.Definition = NStr("en = 'The report is used to analyze the retail sales. Report is generated by the scheduled form TORG-29'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.AlcoholicProductsSalesBook, "Default");
	Variant.Definition = NStr("en = 'The report is used to generate the sales book of alcohol and alcoholic products'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.FinancialResult, "Statement");
	Variant.Definition = NStr("en = 'Report presents financial results of activity'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.FinancialResultForecast, "Default");
	Variant.Definition = NStr("en = 'Report presents forecast of financial result by selected option'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.FinancialResultForecast, "Planfact analysis");
	Variant.Definition = NStr("en = 'Report compares forecast and actual financial result'");
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.StaffList, "Default");
	Variant.Definition = NStr("en = 'Report presents staff list of the company'");
	...
	Variant.Definition = NStr("en = 'Report shows information on volume of sales with use of discount cards for specific period'");	
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SalesByDiscountCards, "SalesByDiscountCard");
	Variant.Definition = NStr("en = 'The report is called from the ""Discount cards"" data processor and presents the data on sales for a discount card by total amount over a certain period of time'");	
	Variant.Enabled = False;
	Variant.VisibleByDefault = False;
	// End DiscountCards
	...
	Variant.Definition = NStr("en = 'The report presents the data on granted automatic discounts in total amounts over a certain period of time'");	
	// End AutomaticDiscounts
	
	Variant = ReportsVariants.VariantDesc(Settings, Metadata.Reports.SegmentComposition, "SegmentCompositionContext");
	Variant.Definition = NStr("en = 'Report displays the current content of the counterparties segment'");
	Variant.Enabled = False;
	Variant.Placement.Clear();
...
//
// ForExample:
// Settings.Search.InputHint = NStr("en = 'ForExample, cost'");
