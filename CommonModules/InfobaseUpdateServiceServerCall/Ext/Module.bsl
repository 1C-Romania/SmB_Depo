...
Procedure WriteExecutionTimeUpdate(UpdateBeginTime, UpdateEndTime) Export
	...
	DurationHours = ?(Hours = 0, "",
		StringFunctionsClientServer.PlaceParametersIntoString(NStr("en = '%1 hour'"), Hours));
	DurationMinutes = ?(Minutes = 0, "",
		StringFunctionsClientServer.PlaceParametersIntoString(NStr("en = '%1 min'"), Minutes));
	DurationSeconds = ?(Seconds = 0, "",
		StringFunctionsClientServer.PlaceParametersIntoString(NStr("en = '%1 sec'"), Seconds));
