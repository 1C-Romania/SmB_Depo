...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If RunMode.SaaS Then
		...
		Items.SectionDescription.Title = NStr("en = 'Data synchronization setup with my applications.'");
		Items.ExplanationDataSynchronizationSettings.Title = NStr("en = 'Setup and data synchronization with my applications.'");
		Items.ExplanationOpenDataImportProhibitionDates.Title = NStr("en = 'Prohibition of the last periods data import out of the other applications.'");
