...
Procedure SetEnabled(AttributePathToData = "")
	...
	If AttributePathToData = "ConstantsSet.UseUserReminders" Or AttributePathToData = "" Then
		
		CommonUseClientServer.SetFormItemProperty(Items, "UsersReminders", "Enabled", ConstantsSet.UseUserReminders);
