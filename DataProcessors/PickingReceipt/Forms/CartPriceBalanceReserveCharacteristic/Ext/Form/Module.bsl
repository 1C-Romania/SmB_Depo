...
Procedure AddProductsAndServicesToCart()
	...
	If SelectionSettingsCache.RequestQuantity
		...
		OpenForm("DataProcessor.PickingReceipt.Form.QuantityAndPrice", CartRowData, ThisForm, True, , ,NotificationDescriptionOnCloseSelection , FormWindowOpeningMode.LockOwnerWindow);
...
Function GetDataProductsAndServicesOnChange(StructureData)
	...
	If StructureData.Property("CounterpartyPriceKind") Then
		...
		StructurePriceAndMeasurementUnit = PickProductsAndServicesInDocuments.GetPriceAndProductsAndServicesMeasurementUnitByCounterpartyPricesKind(StructureData);
...
Procedure FillObjectData()
	...
	Object.PriceKindCurrency = Object.CounterpartyPriceKind.PriceCurrency;
...
Procedure FillInformationAboutDocument(InformationAboutDocument)
	...
	DataProcessors.PickingReceipt.InformationAboutDocumentStructure(InformationAboutDocument);
...
Procedure SetFormItemsProperties()
	...
	CommonUseClientServer.SetFormItemProperty(Items, "ProductsAndServicesListContextMenuChangePrice", "Enabled", ValueIsFilled(Object.CounterpartyPriceKind));
	CommonUseClientServer.SetFormItemProperty(Items, "CharacteristicsListContextMenuPriceSetNew", "Enabled", ValueIsFilled(Object.CounterpartyPriceKind));
	...
	CommonUseClientServer.SetFormItemProperty(Items, "CartPriceBalanceReserveCharacteristicReserve", "Visible", False);
...
// Procedure waiting processor. Output user advice on top of selection window
//
Procedure CouncilServicesOutputInReceiptDocuments()
	
	If SelectionSettingsCache.CouncilServicesOutputInReceiptDocuments Then
		
		FormTitle = NStr("en = 'Advice'");
		MessageText = NStr("en = 'Services in the supplier documents reflect expenses of the company, that is why the characteristics are limited.'");
...
Procedure ChangeSettings(Command)
	...
	OpenForm("DataProcessor.PickingReceipt.Form.Setting", , ThisForm, True, , , NotifyDescription, FormWindowOpeningMode.LockOwnerWindow);
...
Procedure DecryptReserve(Command)
	...
	OpenForm("DataProcessor.PickingReceipt.Form.DecryptReserve", DetailsParameters, ThisForm, True, , ,NotificationDescriptionOnCloseSelection , FormWindowOpeningMode.LockOwnerWindow);
...
Procedure InformationAboutDocument(Command)
	...
	OpenForm("DataProcessor.PickingReceipt.Form.InformationAboutDocument", SelectionSettingsCache.InformationAboutDocument, ThisForm, True, , ,NotificationDescriptionOnCloseSelection, FormWindowOpeningMode.LockOwnerWindow);
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	DataProcessors.PickingReceipt.CheckParametersFilling(Parameters, Cancel);
	...
	SelectionSettingsCache.Insert("CouncilServicesOutputInReceiptDocuments", SmallBusinessReUse.GetValueOfSetting("CouncilServicesOutputInReceiptDocuments"));
	...
	SelectionSettingsCache.Insert("PricesKindPriceIncludesVAT", ?(ValueIsFilled(Object.CounterpartyPriceKind), Object.CounterpartyPriceKind.PriceIncludesVAT, Object.AmountIncludesVAT));
	SelectionSettingsCache.Insert("InformationAboutDocument", InformationAboutDocument);
	
	SelectionSettingsCache.Insert("AllowedToChangeAmount", SmallBusinessAccessManagementReUse.AllowedEditDocumentPrices()
...
Procedure ListInventorySelection(Item, SelectedRow, Field, StandardProcessing)
	...
	If Not DataCurrentRows.IsService 
		AND DataCurrentRows.UseCharacteristics Then
	...
	Else
		...
		If DataCurrentRows.UseCharacteristics Then
			...
			CouncilServicesOutputInReceiptDocuments(); // It is actual only in the supplier documents
