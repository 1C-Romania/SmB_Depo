...
Procedure FillCorrespondence(DataByCorrespondence)
	...
	For Each InteractionItem IN DataByCorrespondence.Interactions Do 
		...
		NewInteraction.Definition = ?(IsBlankString(InteractionItem.Description), NStr("en = '<Without text>'"), InteractionItem.Description);
		...
		NewInteraction.ExplanationToPicture = ?(InteractionItem.Incoming, NStr("en = 'inc.'"), NStr("en = 'Source.'"));
