...
Procedure BeforeClose(Cancel, StandardProcessing)
	...
	If Not SoftwareClosing AND Modified Then
		...
		QuestionText = NStr("en = 'Data is modified. Save changes?'");
...
Procedure StateCodeStartChoice(Item, ChoiceData, StandardProcessing)
	...
	If StatesCodesList = Undefined Then
		...
		WarningText = NStr("en = 'Codes list has not been imported yet. Click the Import reference or enter a state code manually.'");
