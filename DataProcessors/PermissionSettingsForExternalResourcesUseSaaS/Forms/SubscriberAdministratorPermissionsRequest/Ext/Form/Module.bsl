...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	ControlApplicationExternalAddress = Constants.ControlApplicationExternalAddress.Get();
...
&AtClient
Procedure DecorationRequestsDataProcessorTitleNavigationDataProcessorRefs(Item, URL, StandardProcessing)
	
	If URL = "internal://sm" Then
		
		StandardProcessing = False;
		GotoURL(ControlApplicationExternalAddress + "?N=" + UserName() + "&C=PermissionRequest" + String(PackageIdentifier));
