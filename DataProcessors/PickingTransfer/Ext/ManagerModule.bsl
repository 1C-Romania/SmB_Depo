...
Procedure InformationAboutDocumentStructure(ParametersStructure) Export
	...
	For Each DataProcessorAttribute IN Metadata.DataProcessors.PickingTransfer.Attributes Do
...
Function MandatoryParametersStructure()
	...
	Return New Structure("Date, Company, ProductsAndServicesType, OwnerFormUUID, StructuralUnitSender, OperationKind", "Date", "Company", "Products and services type", "Unique identifier of the owner form", "Warehouse sender", "Transaction kind");
...
Function ChoiceFormFullName() Export
	...
	Return "DataProcessor.PickingTransfer.Form.CartRemainsReserveCharacteristics";
