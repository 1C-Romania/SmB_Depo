...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.UseDigitalSignatures.Visible                = Not RunMode.BaseVersion;
	Items.DigitalSignaturesAndEncryptionSettings.Visible        = Not RunMode.BaseVersion;
	Items.UseEDExchangeWithBanks.Visible                   = Not RunMode.BaseVersion;
...
Procedure SetEnabled(AttributePathToData = "")
	...
	If AttributePathToData = "ConstantsSet.UseEDExchange"
		...
		CommonUseClientServer.SetFormItemProperty(Items, "DigitalSignaturesAndEncryptionSettings", 	  "Enabled", InludedEDandDS);
