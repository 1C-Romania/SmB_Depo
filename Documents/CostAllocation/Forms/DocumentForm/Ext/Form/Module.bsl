...
Procedure InventoryFillByStandards(Command)
	...
	If Object.Inventory.Count() <> 0 Then
		...
		QuestionText = NStr("en = 'The ""Inventory"" tabular section will be refilled.'") + Chars.LF;
		If Object.InventoryDistribution.Count() <> 0 Then
			QuestionText = QuestionText + NStr("en = 'Tabular section ""inventory distribution""  will be cleared!'") + Chars.LF;
		EndIf;	
...
Procedure InventoryDistributeByStandards(Command)
	...
	If Object.InventoryDistribution.Count() <> 0 Then
		...
		ShowQueryBox(New NotifyDescription("InventoryDistributeByStandardsEnd", ThisObject), NStr("en = 'The ""Inventory allocation"" tabular section will be refilled. Continue?'"), 
...
Procedure InventoryDistributeByQuantity(Command)
	...
	If Object.InventoryDistribution.Count() <> 0 Then
		...
		ShowQueryBox(New NotifyDescription("InventoryDistributeByQuantityEnd", ThisObject), NStr("en = 'The ""Inventory allocation"" tabular section will be refilled. Continue?'"), 
							QuestionDialogMode.YesNo, 0);
        Return;
...
Procedure CostsFillByBalance(Command)
	...
	If Object.Costs.Count() <> 0 Then
		...
		QuestionText = NStr("en = 'Tabular section ""Costs"" will be refilled!'") + Chars.LF;
		QuestionText = QuestionText + NStr("en = 'Tabular section ""Expenses distribution"" will be refilled! Do you want to continue operation?'") + Chars.LF;
		QuestionText = QuestionText + NStr("en = 'Continue?'");
		Response = Undefined;
...
Procedure CostsDistributeByQuantity(Command)
	...
	If Object.CostAllocation.Count() <> 0 Then
		...
		ShowQueryBox(New NotifyDescription("AllocateCostsByQuantityEnd", ThisObject), NStr("en = 'The ""Expenses allocation"" tabular section will be refilled. Continue?'"), 
							QuestionDialogMode.YesNo, 0);
        Return;
...
Procedure ProductsFillByOutput(Command)
	...
	If Object.Products.Count() <> 0 Then
		...
		ShowQueryBox(New NotifyDescription("ProductsFillByOutputEnd", ThisObject), NStr("en = 'The ""Production"" tabular section will be refilled. Continue?'"), 
							QuestionDialogMode.YesNo, 0);
        Return;
