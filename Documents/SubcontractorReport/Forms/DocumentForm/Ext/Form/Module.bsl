...
Procedure BasisDocumentOnChange(Item)
	...
	If Object.Prepayment.Count() > 0
	   ...
	   AND CounterpartyDoSettlementsByOrders Then
		...
		ShowQueryBox(New NotifyDescription("BaseDocumentOnChangeEnd", ThisObject), NStr("en = 'Prepayment set-off will be cleared, do you want to continue?'"), Mode, 0);
        Return;
	EndIf;
...
Procedure CommandFillBySpecification(Command)
	...
	If Object.Inventory.Count() <> 0 Then
		...
		ShowQueryBox(New NotifyDescription("CommandToFillBySpecificationEnd", ThisObject), NStr("en = 'The ""Inventory"" tabular section will be refilled. Continue?'"), 
