...
Procedure OnLoadDataFromSettingsAtServer(Settings)
	...
	SmallBusinessClientServer.SetListFilterItem(List, "Division", FilterDivision, ValueIsFilled(FilterDivision));
...
Procedure CreateAcceptanceCertificate(Command)
	...
	Else
		...
		If DataStructure.GenerateFewOrders Then
			...
			MessageText = NStr("en = 'The orders differ by data (%DataPresentation%) of the documents header! Form some acceptance certificates?'");
