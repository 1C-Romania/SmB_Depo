...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Users.InfobaseUserWithFullAccess() Then
		...
		Raise NStr("en = 'The rights are not sufficient for setting the offline work.'");
		
	ElsIf Not OfflineWorkService.OfflineWorkSupported() Then
		
		Raise NStr("en = 'Possibility of autonomous work in the application is not provided.'");
...
Procedure HowToSetOfflineWorkplace(Command)
	...
	FormParameters.Insert("Title", NStr("en = 'Hot to configure the offline workplace'"));
