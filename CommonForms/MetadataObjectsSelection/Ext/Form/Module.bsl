...
Procedure MetadataObjectTreeFill()
	...
	CollectionsOfMetadataObjects_NewRow("SessionParameters",              NStr("en='Session settings';ru='Параметры сеанса'"),               39, 40, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("EventSubscriptions",            NStr("en='Event subscriptions';ru='Подписки на события'"),            47, 48, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("FunctionalOptionsParameters", NStr("en='Functional options parameters';ru='Параметры функциональных  опций'"), 53, 54, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("SettingsStorages",            NStr("en='Setting storages';ru='Хранилища настроек'"),             55, 56, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("CommonCommands",                 NStr("en='Common command';ru='Общие команды'"),                  59, 60, True, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("DocumentJournals",            NStr("en='Document journals';ru='Журналы документов'"),             PictureLib.DocumentJournal,       PictureLib.DocumentJournal,             False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Enums",                 NStr("en='Enums';ru='Перечисления'"),                   PictureLib.Enum,           PictureLib.Enum,                 False, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("DataProcessors",                    NStr("en='DataProcessors';ru='Обработки'"),                      PictureLib.DataProcessor,              PictureLib.DataProcessor,                    False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfCharacteristicTypes",      NStr("en='Charts of characteristics types';ru='Планы видов характеристик'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
	...
	CollectionsOfMetadataObjects_NewRow("ChartsOfCalculationTypes",            NStr("en='Charts of characteristics types';ru='Планы видов характеристик'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
