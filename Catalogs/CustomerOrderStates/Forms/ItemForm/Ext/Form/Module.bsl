...
Procedure SetMainItem()
	...
	If Object.Ref <> SmallBusinessReUse.GetValueOfSetting("StatusOfNewCustomerOrder") Then
		SmallBusinessServer.SetUserSetting(Object.Ref, "StatusOfNewCustomerOrder");	
...
Procedure AfterWrite(WriteParameters)
	...
	Notify("Record_CustomerOrderStates");
